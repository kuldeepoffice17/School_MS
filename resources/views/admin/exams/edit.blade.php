                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('term') is-invalid @enderror" 
                                        ...
                                        <option value="first_term" {{ old('term', $exam->term) == 'first_term' ? 'selected' : '' }}>First Term</option>
                                        <option value="second_term" {{ old('term', $exam->term) == 'second_term' ? 'selected' : '' }}>Second Term</option>
                                        <option value="third_term" {{ old('term', $exam->term) == 'third_term' ? 'selected' : '' }}>Third Term</option>
                                        <option value="final" {{ old('term', $exam->term) == 'final' ? 'selected' : '' }}>Final Exam</option>
                                    </select>
                                    @error('term')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('start_date') is-invalid @enderror" 
                                           id="start_date" name="start_date" value="{{ old('start_date', $exam->start_date) }}" required>
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('end_date') is-invalid @enderror" 
                                           id="end_date" name="end_date" value="{{ old('end_date', $exam->end_date) }}" required>
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              id="description" name="description" rows="4">{{ old('description', $exam->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
